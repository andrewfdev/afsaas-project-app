class ProjectsController < ApplicationController
  ...
  private
    ...
    def verify_tenant
      ...
      unless params[:tenant_id] == current_user.tenants.first.id.to_s
        
        redirect_to :root, flash:  { error: "You are not authorised to access any orgainisation other than your own - #{current_user.tenants.first.inspect}"}
      end
    end
end
